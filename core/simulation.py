...
class SimulationEngine:
    ...
    def _calculate_pv_production(self, params: Dict, weather_response: Dict) -> Dict:
        ...
        try:
            # NOUVEAU : Récupération du paramètre use_simple_model
            use_simple_model = params.get('use_simple_model', False)
            ...
            production_results = simulate_pv_system(
                ...
                use_simple_model=use_simple_model  # NOUVEAU PARAMÈTRE
            )
            ...
            model_used = production_results.get('model_used', 'Unknown')
            logger.info(f"Modèle PV utilisé: {model_used}")
    ...
    def _compile_results(self, weather_response: Dict, economics: Dict) -> Dict:
        ...
        return {
            ...
            "simulation_metadata": {
                ...
                "model_used": self.pv_production.get('model_used', 'Unknown')
            }
        }
    ...
    def get_simulation_summary(self) -> Dict:
        ...
        return {
            ...
            "pv_model_used": self.pv_production.get('model_used', 'Unknown')
        }
